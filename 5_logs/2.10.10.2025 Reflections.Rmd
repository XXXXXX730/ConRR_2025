...
```
B. Another important observation I made was the possibility to still call the row by the numerical index even after being renamed by the function `rownames()`. For example, I want to tie it the previous knowledge gene expression related data and how rowname might be important than the sole number used to index the dataset. 
